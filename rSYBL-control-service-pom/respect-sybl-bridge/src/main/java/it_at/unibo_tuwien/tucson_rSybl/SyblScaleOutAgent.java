...
public class SyblScaleOutAgent extends AbstractTucsonAgent {
     ...
     */
    public SyblScaleOutAgent(final String id, final int p, final Node cs, final Node n) throws TucsonInvalidAgentIdException {
        super(id, SyblScaleOutAgent.HOST, p);
        this.controlledService = cs;
        this.node = cs;
        try {
            this.tid = new TucsonTupleCentreId(SyblScaleOutAgent.TC, super.myNode(), String.valueOf(super.myport()));
    ...
    protected String scaleOutAndWaitUntilNewServerBoots(final Node entity,
            final Node controller) throws InvalidVarNameException {
    ...
    private void scaleOutComponent(final Node n) throws InvalidVarNameException {
