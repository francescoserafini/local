...
if __name__=='__main__':
	...
	composition_file = open("./changeRequirement.xml", "r")
	body_content =  composition_file.read()
	connection.request('PUT', url+'/replaceCloudServiceRequirementsFromCurrentCloudService', body=body_content,headers=headers,)
	result = connection.getresponse()
	print result.read()
